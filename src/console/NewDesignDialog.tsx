...
/**
 * Miniatura do modelo, desenhada a partir do PRÓPRIO documento.
 *
 * Podia ser um mock em SVG feito à mão para cada modelo, e seria menos código —
 * mas aí o seletor mostraria uma coisa e o editor abriria outra assim que
 * alguém mexesse em starterTemplates.ts. Derivar da mesma fonte é o que garante
 * que o que você escolhe é o que você recebe.
 *
 * Renderiza a página em tamanho real dentro de um `scale`, em vez de recalcular
 * cada medida em porcentagem: assim tamanho de fonte, raio e espessura encolhem
 * na mesma proporção que as posições, que é o que uma miniatura fiel exige.
 */
function StarterPreview({ doc, width }: { doc: Doc; width: number }) {
